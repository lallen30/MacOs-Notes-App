...
struct ContentView: View {
    ...
    var body: some View {
        VStack {
            ...
            Button("Create and Edit Subcategory") {
                ...
                let subcategory = createTestSubcategory(in: category)
        ...
        .sheet(isPresented: $showingSheet) {
            if let subcategory = selectedSubcategory {
                EditSubcategorySheet(subcategory: subcategory)
            } else {
    ...
    private func createTestSubcategory(in category: Category) -> SubCategory {
        ...
        do {
            ...
            print("Error saving subcategory: \(error.localizedDescription)")
        }
