...
// A completely separate mini-app for editing subcategories
struct MiniSubcategoryEditor: View {
...
// A simple wrapper to present the MiniSubcategoryEditor
struct MiniSubcategoryEditorWrapper: View {
    let subcategoryID: NSManagedObjectID
    
    var body: some View {
        MiniSubcategoryEditor(subcategoryID: subcategoryID)
    }
}
